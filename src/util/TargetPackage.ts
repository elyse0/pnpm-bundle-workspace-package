...
class TargetPackage {
    ...
    constructor(pkg: Project, workspace: Workspace) {
        ...
        this.workspaceDependencies = TargetPackage.getWorkspaceDependencies(workspace, pkg);
    }
    ...
    private static getWorkspaceDependencies(workspace: Workspace, pkg: Project): Project[] {
        const targetPackageDependencies: Project[] = [];
        const recursive = (pkg: Project) => {
            const packageDependenciesList = TargetPackage.getPackageDependenciesList(pkg);
            ...
            packageDependenciesList.forEach(dependencyName => {
                ...
                if (workspacePackage && !targetPackageDependencies.includes(workspacePackage)) {
